...
public class RadarSysSprint2ControllerOnRaspMain implements IApplication{
	...
	public void setup( String domainConfig, String systemConfig )  {
		...
		if( domainConfig == null && systemConfig == null) {
	    	...
	    	DomainSystemConfig.ledGui      = false;		//sul rasp da mettere a false	
	    	
			RadarSystemConfig.RadarGuiRemote    = true;		//a true non crea il radar in locale (ne usa uno remoto)
			RadarSystemConfig.serverPort        = 8080;		
			RadarSystemConfig.hostAddr          = "192.168.1.7"; //"localhost"; //mettere ip a cui collegarsi
