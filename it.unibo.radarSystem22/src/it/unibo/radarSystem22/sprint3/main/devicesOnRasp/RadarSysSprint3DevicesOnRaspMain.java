...
public class RadarSysSprint3DevicesOnRaspMain implements IApplication{
	...
	public void setup( String domainConfig, String systemConfig )  {
		...
		if( domainConfig == null && systemConfig == null) {
	    	...
	    	DomainSystemConfig.ledGui      = false;		//se siamo su PC a true, rasp a false	
	...
	public static void main( String[] args) throws Exception {
		...
		new RadarSysSprint3DevicesOnRaspMain().doJob("DomainSystemConfig.json","RadarSystemConfig.json"); //inizialmente (null,null)
  	}
}
