...
public class ItemObserver implements IApplication, Observer{
 	private ISonar  sonar ;
 	private Distance news;
	...
	public void setup( String domainConfig, String systemConfig )  {
		...
		RadarSystemConfig.ctxServerPort    = 8080;
		RadarSystemConfig.raspAddr         = "192.168.137.139"; 
	...
	protected void configure() {		
		...
		sonar    		      = new SonarObservable("sonarPxy", host, ctxport, protocol );
	...
	public static void main( String[] args) throws Exception {
		new ItemObserver().doJob(null,null);
 	}
	...
	public void update(Observable o, Object arg) {
		...
		if(arg instanceof Distance) {
			...
			System.out.println("-----Strange change!!!");
		}
